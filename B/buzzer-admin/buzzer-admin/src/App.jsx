...
function App() {
  ...
  const enableBuzzer = () => {
    axios.post("http://192.168.43.206:3000/enablebuzzer", {});
  };

  const disableBuzzer = () => {
    axios.post("http://192.168.43.206:3000/disablebuzzer", {});
  };

  const getLatestBuzz = () => {
    axios.post("http://192.168.43.206:3000/getlatestbuzz", {}).then((res) => {
